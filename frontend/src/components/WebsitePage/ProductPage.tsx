...
const ProductPage = () => {
    ...
    const getProduct = async(): Promise<void> => {
        try {
            const savedResponse = await fetch(`${process.env.REACT_APP_BASE_URL}/getproductbyid/${productId}`, {
                method: "GET",
            })
            ...
            setData(response.data)
                ...
                const reviewByProduct = await fetch(`${process.env.REACT_APP_BASE_URL}/getreviewbyprodid/${productId}`, {
                    method: "GET",
                })
    ...
    const buttonHandler = async (id: string): Promise<void> => {
        ...
        try {
            const savedUserResponse = await fetch(`${process.env.REACT_APP_BASE_URL}/uploadreview`, {
                method: "POST",
                headers: {
